...
const Footer = () => {
  return (
    <footer className="mt-auto hidden bg-white text-gray-900 md:block">
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            <Button href="/" className="text-2xl font-semibold ">
              Shoppy
            </Button>
          </div>
        ...
        <div className="font-light sm:flex sm:items-center sm:justify-between">
